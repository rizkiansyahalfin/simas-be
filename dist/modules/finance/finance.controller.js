...
export const getCashById = async (req, res, next) => {
    try {
...
export const postCash = async (req, res, next) => {
    try {
...
export const putCash = async (req, res, next) => {
    try {
        const id = Number(req.params.id);
...
export const deleteCash = async (req, res, next) => {
    try {
        const id = Number(req.params.id);
...
export const getZis = async (req, res, next) => {
    try {
        const page = parsePage(req.query.page);
        const limit = parseLimit(req.query.limit);
        const filters = {
...
export const getZisById = async (req, res, next) => {
    try {
        const id = Number(req.params.id);
...
export const postZis = async (req, res, next) => {
    try {
...
export const putZis = async (req, res, next) => {
    try {
        const id = Number(req.params.id);
...
export const deleteZis = async (req, res, next) => {
    try {
        const id = Number(req.params.id);
